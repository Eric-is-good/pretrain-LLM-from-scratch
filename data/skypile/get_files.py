...
FILE_DIR = "E:\\Projects\\HolmesLM\\dataset\\skypile\\2"
...
if __name__ == "__main__":
    ...
    with open("data\\skypile\\url2.txt", "a", encoding="utf-8") as f:
        for i in range(11):
            f.write(f"https://huggingface.co/datasets/Skywork/SkyPile-150B/resolve/main/data/2023-14_zh_middle_{i:04d}.jsonl\n")